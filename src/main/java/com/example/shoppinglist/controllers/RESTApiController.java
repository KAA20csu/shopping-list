...
public class RESTApiController {
    ...
    private void update(@PathVariable("id") Long id) {
        ...
        productService.update(id, product.get().getName(), product.get().getCategory(), product.get().isBought() ? false : true);
    }
    ...
    private ResponseEntity<String> addProduct(@RequestBody JSONObject jsonProduct) {
        ...
        var category = jsonProduct.get("productCategory").toString();
